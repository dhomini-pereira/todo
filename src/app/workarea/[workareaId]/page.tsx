// "use client";
// import { API_URL, API_URL_WS } from "@/app/globals";
...
//       try {
//         loading.toggle();
//         const [taskList, workarea, usersList, user] = await Promise.all([
//           api.get(`${API_URL}/workarea/${workareaId}/tasks`),
...
//           pending: taskList.data.filter(
//             (task: ITask) => task.status === "PENDING"
//           ),
//           progressing: taskList.data.filter(
//             (task: ITask) => task.status === "PROGRESSING"
//           ),
//           done: taskList.data.filter((task: ITask) => task.status === "DONE"),
//         };
...
//       <Navbar user={user} />
//       <CreateTask workareaId={workareaId} users={users} />
//       {showDeleteModal && (
//         <DeleteTask
...
//                   onClick={() =>
//                     router.push(`/workarea/${workareaId}/settings`)
//                   }
//                 />
//               </div>
