...
export default function Profile() {
  ...
  const changePhoto = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const request = await toast.promise(api.put(url, { imageURL: base64 }), {
      pending: "Uploading...",
      success: "Uploaded",
      error: "Error upload",
    });
        ...
        <div className="bg-slate-900 h-[100%] sm:rounded-tl-[150px] flex flex-col items-center justify-start p-8">
          <div className="w-[90%]">
            ...
            <p className="text-slate-500">
              Aqui você pode ver e editar informações do seu perfil.
            </p>
          </div>
              ...
              <div className="placeholder:opacity[1] placeholder:text-[#9ca3af] placeholder:font-semibold placeholder:text-[1.3em]">
                ...
                >
                  ...
                  <input
                    type="email"
                    placeholder="Email"
                    className="p-2 rounded-md bg-slate-700 text-slate-200 disabled:bg-slate-500"
